...
## Breaking News
I have released a bet copy of midi-qol that is compatible with dnd5e 3.0+
Doing the upgrade requires several steps. Please read https://githug.com/tposney/midi-qol/-/blo for instructions
